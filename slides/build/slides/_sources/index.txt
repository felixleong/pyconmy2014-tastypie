...
- Normal ORM optimization tips apply -- **select_related() and prefetch_related()
  are your friends** :).
- Apply your Django DB/ORM optimization tricks to ``Resource.Meta.queryset`` or
...
- Django 1.7 will have `django.utils.module_loading.autodiscover_modules` [1]_

.. [1] Tastypie 0.11 is not compatible with Django 1.7
