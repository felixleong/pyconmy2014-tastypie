...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_article', (
            ...
            ('time_published', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 7, 0, 0))),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(blank=True, default=datetime.datetime.now)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('summary', self.gf('django.db.models.fields.TextField')(null=True, blank=True, default=None)),
        ))
    ...
    models = {
        ...
        'blog.article': {
            ...
            'summary': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True', 'default': 'None'}),
            ...
            'time_published': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 0, 0)'}),
